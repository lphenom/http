...
/**
 * PHAR build script for lphenom/http.
 *
...
$pharFile = $buildDir . '/lphenom-http.phar';

if (file_exists($pharFile)) {
    unlink($pharFile);
}

$phar = new Phar($pharFile, 0, 'lphenom-http.phar');
$phar->startBuffering();
...
$stub = <<<'STUB'
<?php
Phar::mapPhar('lphenom-http.phar');
require 'phar://lphenom-http.phar/vendor/autoload.php';
__HALT_COMPILER();
STUB;
